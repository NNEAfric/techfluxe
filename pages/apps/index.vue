      ...
      <v-flex xs12 md9>
        <v-container fluid>
          <div>
            ...
            <h1 class="title-text gradient-text hidden-xs-only pb-3" style="font-size: 6vw;">Apps</h1>
            <Indicator class="hidden-sm-and-up" colour="primary" size="12" />
            <h1 class="gradient-text hidden-sm-and-up pb-3" style="font-size: 15vw;">Apps</h1>
          </div>
        
          <!--Start Feeds-->
          <div v-for="feed in feeds" :key="feed.title" class="my-4" @click="onLoadFeed(feed.id, feed.year, feed.month, feed.day, feed.title)">
...
export default {
  head() {
    return {
      title: 'Apps | Techfluxe',
      meta: [
        { name: 'keywords', content: 'TechFluxe, apps news, software news, apps news in africa, best tech news in africa' },
        { hid: 'description', name: 'description', content: 'Apps news, apps news in africa' },
        { property: 'og:site_name', content: 'TechFluxe' },
        { property: 'og:og:site', content: 'tecfluxe.com' },
        { property: 'og:title', content: 'Category: Apps' },
        { property: 'og:description', content: '' },
        { property: 'og:image', content: '/img/feeds/f1.png' },
        { property: 'og:url', content: 'https://techfluxe.netlify.com/apps/' },
