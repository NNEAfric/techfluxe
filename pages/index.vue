    ...
    <v-layout row class="pt-0 mt-0">
      <v-flex xs12 sm12 md9>
        <v-container fluid>
          <!--Start Carousel-->
          <v-card flat>
            <v-carousel hide-controls class="elevation-0" height="400">
              <v-carousel-item
                  ...
                  <v-container fill-height fluid style="background-color: rgba(0, 0, 0, 0.5);">
                    <v-layout align-center justify-center column fill-height>
                      <v-flex xs12>
                        ...
                        <div class="border-left"> <div class="px-3"><span class="display-1 font-weight-black" style="color: rgba(255, 255, 255, 0.9);">Foursquare’s Hypertrending helps you spy on the coolest local happenings </span></div> </div>
                      </v-flex>
                    </v-layout>
                  </v-container>
                </v-img>
          ...
          <div class="pt-5 pb-2 border-bottom">
            <Indicator colour="#EE3477" size="15"/>
            <span class="title font-weight-bold ml-1">Latest News</span>
          </div>
          <Feeds/>
          <!--Start Latest Feeds-->
        </v-container>
